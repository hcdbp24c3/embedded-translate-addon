  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500">Supports OpenAI, Gemini (openai compat), Groq, Ollama http://localhost:11434/v1</p>
      </div>
      ...
      {installUrl && <div className="bg-gray-100 p-3 rounded">
        <p className="text-sm">If Stremio didn't open, copy this URL into Stremio → Addons → Add Addon:</p>
        <code className="block break-all text-xs mt-2 bg-white p-2 border">{installUrl}</code>
      </div>}
    </div>
  )
}
TS
cat web/src/Configure.tsx | head -n 20
